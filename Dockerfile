FROM alpine:3.8.8-alpine3.13

ENV GAM_VERSION=6.29.07
...
RUN BUILD_TOOLS="gcc musl-dev libffi-dev swig libusb-dev pcsc-lite-dev openssl-dev cargo" \
    ...
    && mkdir /gam \
    && cd /tmp \
    && curl -L -o /tmp/v$GAM_VERSION.tar.gz https://github.com/taers232c/GAMADV-XTD3/releases/tag/v$GAM_VERSION.tar.gz \
...
LABEL org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vcs-url="https://github.com/Faire/it-eng-iam-gam-docker"
